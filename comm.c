...
// function defintion for sendDATA(), this function will calculate 16000
// sample for 8 pieces for paster decibel values and send them using
// curl library function to an URL. The format of POST fata is
// "cb=num1;num2;num3;...num8"
